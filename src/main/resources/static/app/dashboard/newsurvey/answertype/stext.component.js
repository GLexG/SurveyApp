...
let StextComponent = class StextComponent {
    constructor(fb) {
        this.fb = fb;
    }
    addAnswerShortText() {
...
], StextComponent.prototype, "contractGroup", void 0);
StextComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.StextComponent = StextComponent;
//# sourceMappingURL=stext.component.js.map